export const designSystemColors = {
  ...
  "background-color-bg-primary-hover":
    "rgb(var(--background-color-bg-primary-hover) / var(--background-color-bg-primary-hover-alpha))",
...
"rgb(var(--background-default-color-bg-subtle) / var(--background-default-color-bg-subtle-alpha))",
 "background-default-color-bg-elevated": "rgb(var(--background-default-color-bg-elevated) / <alpha-value>)",
  ...
  "background-success-color-bg-success-muted":
    "rgb(var(--background-success-color-bg-success-muted) / <alpha-value>)",
  "background-success-color-bg-success-strong":
    "rgb(var(--background-success-color-bg-success-strong) / <alpha-value>)",

  "background-error-color-bg-error-strong":
    "rgb(var(--background-error-color-bg-error-strong) / <alpha-value>)",
  "background-error-color-bg-error-muted":
    "rgb(var(--background-error-color-bg-error-muted) / <alpha-value>)",

  "background-magic-color-bg-magic-muted":
    "rgb(var(--background-magic-color-bg-magic-muted) / var(--background-magic-color-bg-magic-muted-alpha))",

  "background-warning-color-bg-warning-muted":
    "rgb(var(--background-warning-color-bg-warning-muted) / <alpha-value>)",
